...
const heroStrips = [
  {
    label: "Command view",
    image: "https://images.unsplash.com/photo-1529070538774-1843cb3265df?q=80&w=4000&auto=format&fit=crop",
  },
  {
    label: "Sterile transit",
    image: "https://images.unsplash.com/photo-1508387024700-9fe5c0b37f33?q=80&w=4000&auto=format&fit=crop",
  },
  {
    label: "Clinical proof",
    image: "https://images.unsplash.com/photo-1581092914649-7d03c1c1b1f4?q=80&w=4000&auto=format&fit=crop",
  },
];
...
const services = [
  {
    ...
    icon: <Icons.Timer />,
    badge: "< 60 min launch",
    image: "https://images.unsplash.com/photo-1582719478248-48c1e7b1c3c7?q=80&w=4000&auto=format&fit=crop",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1473181488821-2d23949a045a?q=80&w=4000&auto=format&fit=crop",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1581094794329-c8112a89af12?q=80&w=4000&auto=format&fit=crop",
...
const gallery = [
  {
    ...
    image: "https://images.unsplash.com/photo-1526256262350-7da7584cf5eb?q=80&w=4000&auto=format&fit=crop",
  },
  {
    title: "Thermal chain control",
    image: "https://images.unsplash.com/photo-1581092334663-1b7e031dfa21?q=80&w=4000&auto=format&fit=crop",
  },
  {
    title: "Strategic dispatch",
    image: "https://images.unsplash.com/photo-1464375117522-1311d6a5b81f?q=80&w=4000&auto=format&fit=crop",
  },
];
      ...
      <section id="hero-section" className="relative w-full h-screen overflow-hidden flex flex-col items-center justify-center pt-20">
        ...
        <div className="relative z-10 w-full max-w-6xl px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex items-center justify-center">
            <div className="absolute -left-16 top-10 hidden lg:flex flex-col gap-4 rotate-[-2deg]">
              {heroStrips.map((strip) => (
                <div
                  key={strip.label}
                  className="w-48 h-20 rounded-xl overflow-hidden shadow-xl border border-white/40 bg-white/40 backdrop-blur"
                  style={{
                    backgroundImage: `linear-gradient(135deg, rgba(37,80,145,0.35), rgba(207,181,59,0.25)), url(${strip.image})`,
                    backgroundSize: "cover",
                    backgroundPosition: "center",
                  }}
                >
                  <div className="h-full w-full bg-gradient-to-r from-black/45 via-transparent to-black/20 flex items-end p-3">
                    <span className="text-white text-[10px] font-bold uppercase tracking-[0.26em] drop-shadow">{strip.label}</span>
                  </div>
                </div>
              ))}
            </div>

            <div id="hero-logo" className="w-full max-w-[560px] h-auto min-h-[300px] flex items-center justify-center rounded-2xl bg-white/70 backdrop-blur-xl border border-white/60 shadow-[0_24px_110px_-40px_rgba(37,80,145,0.55)] relative overflow-hidden">
              <div className="absolute inset-0 opacity-70 bg-gradient-to-br from-regencyBlue/10 via-white to-regencyGold/20"></div>
              <div className="absolute top-4 right-4 px-3 py-1 text-[10px] uppercase tracking-[0.3em] font-bold text-regencyBlue bg-white/70 border border-white/60 rounded-full flex items-center gap-2 shadow-sm">
                <span className="w-2 h-2 rounded-full bg-green-400 animate-pulse"></span>
                Live Dispatch
              </div>
              <div className="absolute bottom-4 right-4 px-3 py-1 text-[10px] uppercase tracking-[0.3em] font-bold text-regencyGold bg-regencyDarkBlue/80 text-white border border-white/20 rounded-full flex items-center gap-2 shadow-sm">
                <span className="w-2 h-2 rounded-full bg-regencyGold"></span>
                4K audit trail
              </div>
              <div className="relative z-10 w-60 h-40 md:w-80 md:h-52">
              ...
              <div className="absolute inset-x-6 bottom-6 h-[2px] bg-gradient-to-r from-regencyBlue via-white to-regencyGold opacity-70"></div>
            </div>
          </div>
        </div>
          ...
          <div className="w-full md:w-1/2 relative h-[520px]">
            <div className="w-full h-full relative overflow-hidden rounded-2xl shadow-2xl border border-white">
              <img
                ...
                src="https://images.unsplash.com/photo-1582719478100-0f83c2d9809c?q=80&w=4000&auto=format&fit=crop"
